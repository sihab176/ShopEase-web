    ...
    <div>
      ...
      <section className="bg-[#bad8c3]  py-16 px-6 md:px-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          {/* Left Content */}
          <div>
            <span className="text-sm tracking-wide uppercase bg-gray-200  px-3 py-1 rounded-full">
              Why Shop With Us
            </span>
          ...
          <div className="space-y-6">
            {/* Card 1 */}
            <div className="bg-gray-200 p-5 rounded-xl flex justify-between items-center shadow-lg hover:bg-gray-300 transition">
