...
//   const [showModal, setShowModal] = useState(false);
//   const [review, setReview] = useState("");
//   const [sessionId, setSessionId] = useState(null); // ✅ store session_id safely

//   // -------------------- SEARCH PARAMS (CLIENT ONLY) -----------------
//   useEffect(() => {
...
//             <div className="text-center">
//               <figure className="flex justify-center items-center">
//                 <img src="/speech-bubble.png" alt="success logo" className="lg:w-28 md:w-18 w-12" />
//               </figure>
//               <h3 className="md:text-4xl text-2xl font-bold my-5">
//                 Submit Your Feedback
//               </h3>
